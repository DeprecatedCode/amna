...
module.exports = function (amna, log) {
    ...
    var Collection = function (thing, options) {
         ...
         * POST /collection
         */
        if (options.collectionPost !== false) {
         ...
         * PUT /collection
         */
        if (options.collectionPut !== false) {
         ...
         * DELETE /collection
         */
        if (options.collectionDelete !== false) {
         ...
         */
        if (options.documentDelete !== false) {
