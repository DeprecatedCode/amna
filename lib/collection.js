...
module.exports = function (amna, log) {
    ...
    var Collection = function (thing, options) {
         ...
         * GET /collection/:id
         */
        this.routes.documentGet = this.documentGet('', function (self, doc) {
            self.done(doc);
        }.bind(this));
         ...
         * POST /collection/:id
         */
        this.routes.documentPost = this.documentPost('', function (self, doc) {
            self.err('Not Implemented');
        }.bind(this));
         ...
         * PUT /collection/:id
         */
        this.routes.documentPut = this.documentPut('', function (self, doc) {
            /**
         ...
         */
        this.routes.documentDelete = this.documentDelete('', function (self, doc) {
            /**
