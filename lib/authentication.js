...
module.exports = function (amna, log) {
    ...
    //         }
    //         return res.status(401).json(amna.responses.error('Not Authenticated'));
    //     }
    ...
    //         }
    //         return res.status(400).json(amna.responses.error('Password must be at least 6 characters'));
    //     }
